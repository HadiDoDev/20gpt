...
class Database:
    ...
    def check_if_user_has_credit(self, user_id: int, chat_mode : str, raise_exception: bool = True):
        ...
        if credit['is_trial'] and has_credit:
            ...
            if raise_exception:
                raise ValueError(f"شما اعتبار کافی برای درس انتخاب شده را برای ادامه فرایند ندارید.\n لطفا درس انتخاب شده را تغییر داده یا با استفاده از منو و گزینه /purchase اقدام به خرید بسته در درس مورد نظر و افزایش اعتبار خود کنید.")
            else:
                return False
